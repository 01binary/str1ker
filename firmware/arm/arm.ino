...
ros::Publisher statePub("arm1/state", &stateFeedbackMsg);
ros::Publisher rawPub("arm1/raw", &rawFeedbackMsg);
VelocitySubscriber velocitySub("arm1/velocity", velocityCommand);
PositionSubscriber positionSub("arm1/position", positionCommand);
GripperSubscriber gripperSub("arm1/gripper", gripperCommand);
